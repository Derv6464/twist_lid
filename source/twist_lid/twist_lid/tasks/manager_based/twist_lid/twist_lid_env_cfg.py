...
class TwistLidSceneCfg(InteractiveSceneCfg):
    """Configuration for a bottle scene."""
...
class RewardsCfg:
    ...
    object_goal_tracking_fine_grained = RewTerm(
        func=mdp.object_goal_distance,
        params={"std": 0.05, "minimal_height": 0.11, "command_name": "object_pose"},
        weight=5.0,
    )
...
class CurriculumCfg:
    ...
    action_rate = CurrTerm(
        func=mdp.modify_reward_weight, params={"term_name": "action_rate", "weight": -0.5, "num_steps": 10000}
    )

    joint_vel = CurrTerm(
        func=mdp.modify_reward_weight, params={"term_name": "joint_vel", "weight": -0.5, "num_steps": 10000}
    )
...
class TwistLidEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self) -> None:
        ...
        self.scene.object.actuators = {
            "lid_act": ImplicitActuatorCfg(
                joint_names_expr=[".*lid/D6Joint*"],   
                stiffness=1000.0,
                damping=50.0,
